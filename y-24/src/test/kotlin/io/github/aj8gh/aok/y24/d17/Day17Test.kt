...
Day17Test {
  ...
  companion object {
    ...
    private fun inputProviderPart1() = listOf(
      Arguments.of(readExample(DAY_17, EXAMPLE_1), "0,1,2"),
      Arguments.of(readExample(DAY_17, EXAMPLE_2), "4,2,5,6,7,7,7,7,3,1,0"),
      Arguments.of(readExample(DAY_17), "4,6,3,5,6,3,5,2,1,0"),
      Arguments.of(readInput(DAY_17), "7,0,7,3,4,1,3,0,1"),
    )

    @JvmStatic
    private fun inputProviderPart2() = listOf(
      Arguments.of(readExample(DAY_17, EXAMPLE_3), 117440),
      Arguments.of(readInput(DAY_17), 156985331222018L),
    )
  }
}
