...
import io.github.aj8gh.aok.util.DAY_21
...
class Day21Test {
  ...
  companion object {
    ...
    @JvmStatic
    private fun inputProviderPart1() = getInput(126384, 174124)

    @JvmStatic
    private fun inputProviderPart2() = getInput(0, 0)

    private fun getInput(example: Int, answer: Int) = listOf(
      Arguments.of(readExample(DAY_21), example),
      Arguments.of(readInput(DAY_21), answer),
    )
  }
}
