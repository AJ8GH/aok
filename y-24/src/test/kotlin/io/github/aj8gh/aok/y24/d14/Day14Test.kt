...
class Day14Test {
  ...
  companion object {
    ...
    @JvmStatic
    private fun inputProviderPart1() = getInput(0, 215476074)

    @JvmStatic
    private fun inputProviderPart2() = getInput(0, 6285)

    private fun getInput(example: Int, answer: Int) = listOf(
      Arguments.of(readExample(DAY_14), example),
      Arguments.of(readInput(DAY_14), answer),
    )
  }
}
