package io.github.aj8gh.aok.y23.d3
...
class Day3Test {
  ...
  companion object {
    ...
    @JvmStatic
    private fun inputProviderPart1() = getInput(0, 553825)

    @JvmStatic
    private fun inputProviderPart2() = getInput(0, 93994191)

    private fun getInput(example: Int, answer: Int) = listOf(
      Arguments.of(readExample(DAY_3), example),
